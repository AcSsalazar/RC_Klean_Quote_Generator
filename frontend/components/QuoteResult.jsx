      ...
      <div ref={invoiceRef} className="invoice-preview">
        ...
        <div className="invoice-footer">
          ...
          <p style={{ fontSize: "12px", textAlign: "justify" }}>
            Will provide cleaning solutions, equipment, and materials to perform
            cleaning service. RC Klean shall perform the Services in a
            professional and workman-like manner in accordance with generally
            recognized industry standards for similar services and will exercise
            reasonable care and diligence in performing its duties. RC Klean
            hereby agrees to indemnify, hold harmless, and at customer request,
            defend and its affiliates, successors and assigns, and its and their
            officers, directors, employees, agents, successors and assigns, from
            and against any damages, liabilities, deficiencies, actions,
            judgments, interest, awards penalties, fines, losses costs or
            expenses of whatever kind of nature (including, but not limited to,
            attorneys fees and other defense costs) which are caused by the
            actions of RC Klean or any of its employees, agents, subcontractors
            or representatives
          </p>
