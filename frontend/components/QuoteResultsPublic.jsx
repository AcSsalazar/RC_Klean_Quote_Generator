...
const QuoteResultsPublic = ({ result, options, SquareFeetOptions }) => {
  ...
  return (
    <div className="card">
      <h2 className="main-title">Quote Summary</h2>
...
export default QuoteResultsPublic;