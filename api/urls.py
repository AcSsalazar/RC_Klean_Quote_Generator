...
urlpatterns = [
    ...
    path('form/options/', forms_views.QuestionnaireOptionsView.as_view(), name='questionnaire-options'), # GET opciones
    path('form/<int:pk>/', forms_views.QuestionnaireDetailView.as_view(), name='questionnaire-detail'),  # GET detalle
